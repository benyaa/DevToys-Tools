...
internal sealed class TextDelimiterGui : IGuiTool
{
    ...
    private readonly SettingDefinition<bool> _tidyUp = new(
            name: "tidy-up",
            defaultValue: false
    );
    private readonly SettingDefinition<bool> _attackTheClones = new(
        name: "attack-the-clones",
        defaultValue: false
    );

    private readonly SettingDefinition<ExplodeMode> _explodeModeSetting = new(
        name: "explode-mode",
        defaultValue: ExplodeMode.NewLines
    );
    ...
    private readonly IUIMultiLineTextInput _output = MultiLineTextInput().Title(TextDelimiter.Output);
...
;
    ...
    {
        _customDelimiter = SingleLineTextInput("custom-delimiter").Title(TextDelimiter.CustomDelimiter);
                    ...
                    .Title("Settings")
                        .WithChildren(
                            ...
                            .Handle(
                                ...
                                Item(text: TextDelimiter.NewLines, value: ExplodeMode.NewLines),
                                Item(text: TextDelimiter.Spaces, value: ExplodeMode.Spaces),
